        ...
        <div className="flex flex-col gap-12 md:flex-row md:items-center">
          ...
          <div className="hidden md:flex md:flex-1 justify-center items-center">
            <div className="relative w-80 h-80">
              <div className="absolute inset-0 bg-gradient-to-br from-primary/20 to-transparent rounded-full animate-float"></div>
              <div className="absolute w-full h-full flex items-center justify-center">
                <span className="text-8xl font-bold gradient-text">Y</span>
              </div>
            </div>
          </div>
        </div>
